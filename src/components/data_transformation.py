...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            model = self.get_data_transformer_object()

            target_column_name = "math_score"

            # Create X and Y for tarining dataset
            ...
            input_feature_train_arr = model.fit_transform(input_feature_train_df)
            
            # transform the test data
            input_feature_test_arr = model.transform(input_feature_test_df)
